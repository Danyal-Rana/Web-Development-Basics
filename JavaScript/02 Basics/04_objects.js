...
const obj4 = Object.assign({}, obj1, obj2); // {} acts as target object which is returned, and obj1 & obj2 are treated as source object
console.log(obj4);
...
console.log (Object.entries(tinderUser)); // return arrays of array(key value pairs)
